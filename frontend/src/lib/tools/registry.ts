...
export const tools: Tool[] = [
  // ─────────────────────────── PDF (server-side) ───────────────────────────
  t({ slug: "merge-pdf", name: "Merge PDF", description: "Combine multiple PDFs into one document in any order.", category: "pdf", icon: Merge, keywords: ["merge pdf","combine pdf files","pdf merger","join pdf files","merge multiple pdfs"], mode: "client", status: "live", featured: true, savable: true }),
  t({ slug: "split-pdf", name: "Split PDF", description: "Separate a PDF into multiple files or extract page ranges.", category: "pdf", icon: SplitSquareHorizontal, keywords: ["split pdf","split pdf into pages","separate pdf pages","pdf splitter","divide pdf"], mode: "client", status: "live", featured: true, savable: true }),
  t({ slug: "compress-pdf", name: "Compress PDF", description: "Reduce PDF file size while preserving quality.", category: "pdf", icon: Minimize2, keywords: ["compress pdf","reduce pdf size","pdf compressor","make pdf smaller","reduce pdf file size"], mode: "client", status: "live", featured: true, savable: true }),
  t({ slug: "pdf-to-word", name: "PDF to Word", description: "Extract a PDF's text into an editable DOCX file.", category: "pdf", icon: FileType2, keywords: ["pdf to word","convert pdf to word","pdf to docx","pdf to word converter"], mode: "client", status: "live", savable: true }),
  t({ slug: "excel-to-pdf", name: "Excel to PDF", description: "Convert XLS and XLSX spreadsheets to PDF tables.", category: "pdf", icon: FileOutput, keywords: ["excel to pdf","convert excel to pdf","xlsx to pdf","spreadsheet to pdf"], mode: "client", status: "live", savable: true }),
  t({ slug: "pdf-to-jpg", name: "PDF to JPG", description: "Convert each PDF page into a JPG image.", category: "pdf", icon: FileImage, keywords: ["pdf to jpg","convert pdf to jpg","pdf to image","pdf to jpeg"], mode: "client", status: "live", savable: true }),
  t({ slug: "jpg-to-pdf", name: "JPG to PDF", description: "Combine JPG images into a single PDF.", category: "pdf", icon: FileInput, keywords: ["jpg to pdf","image to pdf","convert jpg to pdf","photo to pdf","jpeg to pdf"], mode: "client", status: "live", featured: true, savable: true }),
  t({ slug: "rotate-pdf", name: "Rotate PDF", description: "Rotate all or selected pages of a PDF.", category: "pdf", icon: RotateCw, keywords: ["rotate pdf","rotate pdf pages","turn pdf sideways","rotate pdf and save"], mode: "client", status: "live", savable: true }),
  t({ slug: "watermark-pdf", name: "Watermark PDF", description: "Add text or image watermarks to a PDF.", category: "pdf", icon: Stamp, keywords: ["watermark pdf","add watermark to pdf","pdf watermark","add text watermark to pdf"], mode: "client", status: "live", savable: true }),
  t({ slug: "repair-pdf", name: "Repair PDF", description: "Attempt to recover a damaged or corrupt PDF.", category: "pdf", icon: Wrench, keywords: ["repair pdf","fix corrupted pdf","recover damaged pdf","pdf will not open"], mode: "client", status: "live", savable: true }),
  t({ slug: "ocr-pdf", name: "OCR PDF", description: "Extract text from scanned PDFs with AI text recognition.", category: "pdf", icon: ScanText, keywords: ["ocr pdf", "pdf ocr online", "scanned pdf to text", "make pdf searchable"], mode: "server", status: "live", savable: true }),
  t({ slug: "sign-pdf", name: "Sign PDF", description: "Add your signature image to a PDF document.", category: "pdf", icon: PenTool, keywords: ["sign pdf","electronic signature pdf","add signature to pdf","esign pdf"], mode: "client", status: "live", savable: true }),
  t({ slug: "extract-pages", name: "Extract PDF Pages", description: "Pull selected pages out of a PDF into a new file.", category: "pdf", icon: FileStack, keywords: ["extract pages from pdf", "extract pdf pages", "pdf page extractor", "save pdf pages separately"], mode: "client", status: "live", savable: true }),
  t({ slug: "organize-pages", name: "Rearrange PDF Pages", description: "Reorder, rotate and delete PDF pages visually, then export.", category: "pdf", icon: Files, keywords: ["rearrange pdf pages", "reorder pdf pages", "organize pdf pages", "move pages in pdf", "sort pdf pages"], mode: "client", status: "live", savable: true }),
  t({ slug: "remove-pages", name: "Delete PDF Pages", description: "Delete unwanted pages from a PDF.", category: "pdf", icon: Scissors, keywords: ["delete pages from pdf", "remove pages from pdf", "delete pdf pages", "pdf page remover"], mode: "client", status: "live", savable: true }),
  t({ slug: "add-page-numbers", name: "Add Page Numbers", description: "Insert page numbers with custom position and style.", category: "pdf", icon: ListOrdered, keywords: ["add page numbers to pdf","pdf page numbers","number pdf pages","pdf page numbering"], mode: "client", status: "live", savable: true }),
  t({ slug: "add-header-footer", name: "Add Header & Footer", description: "Add headers, footers and page numbers to every PDF page.", category: "pdf", icon: AlignLeft, keywords: ["add header and footer to pdf","add header to pdf","add footer to pdf"], mode: "client", status: "live", savable: true }),
  t({ slug: "png-to-pdf", name: "PNG to PDF", description: "Combine PNG images into a single PDF document.", category: "pdf", icon: FileInput, keywords: ["png to pdf","convert png to pdf","png to pdf converter","screenshot to pdf"], mode: "client", status: "live", savable: true }),
  t({ slug: "crop-pdf", name: "Crop PDF", description: "Trim white margins or borders from every page of a PDF.", category: "pdf", icon: Crop, keywords: ["crop pdf","crop pdf online","trim pdf margins","remove white space from pdf"], mode: "client", status: "live", savable: true }),
  t({ slug: "resize-pdf", name: "Resize PDF", description: "Scale PDF pages to A4, Letter, Legal or another standard size.", category: "pdf", icon: Maximize2, keywords: ["resize pdf","change pdf page size","pdf to a4","scale pdf pages"], mode: "client", status: "live", savable: true }),
  t({ slug: "flatten-pdf", name: "Flatten PDF", description: "Bake form fields and annotations into the page so they can't be edited.", category: "pdf", icon: Layers, keywords: ["flatten pdf","flatten pdf form","make pdf non editable","lock pdf form fields"], mode: "client", status: "live", savable: true }),
  t({ slug: "edit-pdf-metadata", name: "Edit PDF Metadata", description: "Change a PDF's title, author, subject and keywords.", category: "pdf", icon: FileCog, keywords: ["edit pdf metadata","change pdf author","edit pdf properties","remove pdf metadata"], mode: "client", status: "live", savable: true }),
  t({ slug: "reverse-pdf-pages", name: "Reverse PDF Pages", description: "Flip the page order of a PDF so the last page comes first.", category: "pdf", icon: FlipVertical2, keywords: ["reverse pdf page order","flip pdf page order","reverse pdf pages"], mode: "client", status: "live", savable: true }),
  t({ slug: "bates-numbering", name: "Bates Numbering", description: "Stamp sequential Bates numbers on every page for legal discovery.", category: "pdf", icon: Hash, keywords: ["bates numbering","bates stamp pdf","legal bates numbering","add bates numbers"], mode: "client", status: "live", savable: true }),
  t({ slug: "n-up-pdf", name: "N-up PDF", description: "Place 2, 4, 6 or 9 pages on each sheet to save paper.", category: "pdf", icon: Columns3, keywords: ["print multiple pages per sheet pdf","2 pages per sheet pdf","4 pages per sheet","pdf booklet"], mode: "client", status: "live", savable: true }),
  t({ slug: "alternate-mix-pdf", name: "Alternate & Mix PDF", description: "Interleave two PDFs page by page — ideal for odd/even scan stacks.", category: "pdf", icon: Repeat, keywords: ["combine front and back scans pdf","interleave pdf pages","merge alternate pages"], mode: "client", status: "live", savable: true }),
  ...
  t({ slug: "image-converter", name: "Image Converter", description: "Convert between any image formats — JPG, PNG, WebP, AVIF, GIF, BMP, SVG and ICO — in batch.", category: "image", icon: FileImage, keywords: ["image converter", "convert image format", "any format", "batch convert"], mode: "client", status: "live", featured: true, savable: true }),
