...
export const tools: Tool[] = [
  ...
  t({ slug: "pdf-to-word", name: "PDF to Word", description: "Convert PDF documents to editable DOCX files.", category: "pdf", icon: FileType2, keywords: ["docx", "convert"], mode: "server", status: "soon", savable: true }),
  ...
  t({ slug: "excel-to-pdf", name: "Excel to PDF", description: "Convert XLS and XLSX spreadsheets to PDF.", category: "pdf", icon: FileOutput, keywords: ["xlsx", "convert"], mode: "server", status: "soon", savable: true }),
  ...
  t({ slug: "pdf-to-jpg", name: "PDF to JPG", description: "Convert each PDF page into a JPG image.", category: "pdf", icon: FileImage, keywords: ["image", "convert"], mode: "server", status: "soon", savable: true }),
  ...
  t({ slug: "repair-pdf", name: "Repair PDF", description: "Attempt to recover a damaged or corrupt PDF.", category: "pdf", icon: Wrench, keywords: ["fix", "recover"], mode: "server", status: "soon", savable: true }),
  ...
  t({ slug: "sign-pdf", name: "Sign PDF", description: "Add your signature to a PDF document.", category: "pdf", icon: PenTool, keywords: ["signature", "esign"], mode: "server", status: "soon", savable: true }),
  ...
  t({ slug: "add-header-footer", name: "Add Header & Footer", description: "Add headers and footers to every PDF page.", category: "pdf", icon: AlignLeft, keywords: ["header", "footer"], mode: "server", status: "soon", savable: true }),
